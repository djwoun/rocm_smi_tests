# -*- coding: utf-8 -*-
"""
Created on Wed Nov 12 15:12:01 2025
...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 12 15:03:09 2025
...
def main() -> int:
    ...
    if power_series is not None:
        ...
        ax_power.set_yticks(range(int(ymin), int(ymax) + 1, 20))
...
# %%
    ...
    ax_temp.set_title("rocBLAS GEMM - MI250X")
    t_min = df["time_s"].min()
    t_max = df["time_s"].max()
